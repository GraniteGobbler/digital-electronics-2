...
ISR(TIMER2_OVF_vect)
{
    ...
    static uint8_t seconds = 50;  // Tenths of a second
    static uint8_t minutes = 1;  // Tenths of a second
    ...
    if (no_of_overflows >= 6)
    {
        ...
        //  Reset stopwatch after 1
        // if ((seconds == 59) & (tenths == 9)){ 
        //   lcd_gotoxy(5, 0);
        //   lcd_putc('0');
        //   lcd_gotoxy(4, 0);
        //   lcd_putc('0');
